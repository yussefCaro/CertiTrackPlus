...
print("Usando settings.py para configuración ALLOWED_HOSTS")
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'myapp.context_processors.navigation_menu',
            ],
        },
    },
]
...
# Detectamos si estamos en Render o en local
